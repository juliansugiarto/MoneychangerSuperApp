...
#let glossary-entries = (
  ...
  (key: "jis dor", short: "JISDOR", long: "Jakarta Interbank Spot Dollar Rate", description: "Referensi kurs yang dapat dipantau dan bukan aktivasi kurs outlet otomatis."),
  ...
  (key: "lku", short: "LKU", long: "Laporan Kegiatan Usaha", description: "Bahan pelaporan internal yang memakai transaksi produksi selesai sesuai periode."),
  (key: "maker checker", short: "Maker-checker", long: "Pemisahan pembuat dan pemeriksa", description: "Kontrol yang mencegah pembuat paket menyetujui paketnya sendiri."),
  (key: "b0002", short: "B0002", long: "Form Neraca", description: "Form laporan keuangan yang dipetakan secara terkendali."),
  (key: "b0003", short: "B0003", long: "Form Laba Rugi", description: "Form laporan keuangan yang dipetakan secara terkendali."),
  (key: "b0004", short: "B0004", long: "Form Perubahan Ekuitas", description: "Form laporan keuangan yang dipetakan secara terkendali."),
