...
export const customerInput = z.object({
  ...
  address: z.string().trim().min(8),
  addressType: z.enum(["RUMAH", "KANTOR", "DOMISILI", "LAINNYA"]),
  ...
  npwp: z.string().trim().max(20).optional(),
...
export const appRouter = router({
  ...
  companyProfile: router({
    ...
    update: controllerProcedure.input(z.object({
      ...
      goamlRentityId: z.number().int().positive().optional(),
      goamlReportingUserCode: z.string().trim().max(50).optional(),
