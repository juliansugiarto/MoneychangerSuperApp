...
const pageByPath: Record<string, string> = {
  ...
  "/operasional/stock/kas-awal": "CashOpening",
  "/operasional/stock/saat-ini": "CashCurrentStock",
  "/operasional/stock/opname": "StockOpnameCount",
  "/operasional/stock/penyesuaian": "CashAdjustment",
