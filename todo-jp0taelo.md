...
- [ ] Belum ada test integrasi end-to-end untuk posting saldo rekening bank saat `completeTransaction` (logika menduplikasi pola sisi Rupiah kas yang sudah teruji, tapi jalur bank belum ada test tersendiri) — disarankan verifikasi manual dengan dry-run transaksi Transfer Bank sebelum dipakai nyata.
