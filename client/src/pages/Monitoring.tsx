...
function statusClass(status: string) {
  ...
  if (status === "PENDING_REVIEW" || status === "ESCALATED") return "bg-amber-100 text-amber-700";
  if (status === "CANCELLED" || status === "RETURNED") return "bg-slate-200 text-slate-700";
